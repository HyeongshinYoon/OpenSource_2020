...
class GMM(nn.Module):
    ...
    def __init__(self, opt):
        ...
        self.extractionA = FeatureExtraction(22, ngf=64, n_layers=4, norm_layer=nn.BatchNorm2d) 
        self.extractionB = FeatureExtraction(3, ngf=64, n_layers=4, norm_layer=nn.BatchNorm2d)
